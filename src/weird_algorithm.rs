...
pub fn weird_algorithm(mut n: u64) -> Result<Vec<u64>> {
...
// #[test]
    ...
    //     let n: u64 = 0;
    //     let expected: Error =
    //         Error::InvalidInput("n is 0 but expected 1 ≤ n ≤ 1000000".to_string());
    //     let result: Result<Vec<u64>> = match weird_algorithm(n) {
    //         Ok(_) => Ok(()),
    //         Err(e) => e == expected,
    //     };
    ...
    //     let n: u64 = 1_000_001;
    //     let expected: Error =
    //         Error::InvalidInput("n is 1000001 but expected 1 ≤ n ≤ 1000000".to_string());
    //     let result = weird_algorithm(n).unwrap();
    //     assert_eq!(result, Result(Vec<u64>));
    // }
